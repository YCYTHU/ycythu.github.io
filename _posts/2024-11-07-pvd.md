...
<div align=center><img width="75%" src="https://cdn.jsdelivr.net/gh/ycythu/assets@main/images/PVD MD/deposition ratio.png" alt="图2：p 分别为 0.5 和 0.1 时，在 N=1000 条件下多次模拟的相对误差的分布"></div>
<div align=center><font color="#999999">图2：$p$ 分别为 $0.5$ 和 $0.1$ 时，在 $N=1000$ 条件下多次模拟的相对误差的分布</font></div>
